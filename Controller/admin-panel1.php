...
<html lang="en">
  ...
  <style >
    ...
    background: -webkit-linear-gradient(to right,#2E8B57, #98FB98);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #2E8B57,#98FB98 ); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
