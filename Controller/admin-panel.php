...
<html lang="en">
  ...
  <style >
    ...
    background: #98FB98;  /* fallback for old browsers */
    background: -webkit-linear-gradient(to right, #3CB371, #98FB98);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #3CB371, #98FB98); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
...
.list-group-item.active {
    ...
    color: #fff;
    background: #F0F2F0; 
    background: -webkit-linear-gradient(to right,#3CB371, #98FB98);
    background: linear-gradient(to right, #3CB371, #98FB98);
    border-color: #c3c3c3;
}
.text-primary {
