...
<script>
  ...
  if (document.getElementById('password').value ==
    ...
    document.getElementById('message').style.color = '#66CDAA';
    document.getElementById('message').innerHTML = 'Matched';
  } else {
    document.getElementById('message').style.color = '#008B8B';
...
<body background=
"http://www.unihealthbaypointe.com/wp-content/uploads/2011/11/departments.jpg">
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4 style= "color:MidnightBlue;font-weight:bold;"><i style="color:MidnightBlue;font-weight:bold;" class="fa fa-solid fa-hospital-user" aria-hidden="true"></i>&nbsp HOSPITAL MANAGEMENT SYSTEM</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://www.pngitem.com/pimgs/m/154-1546170_transparent-hospital-icon-png-multidisciplinary-medical-team-icon.png" alt=""/>
                        <h3 style="color:MidnightBlue;font-weight:bold;">Welcome!</h3>
                        <!-- <h3>Welcome!</h3> -->
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Patient Register</h3>
...
<script src="https://kit.fontawesome.com/210843d3e9.js" crossorigin="anonymous"></script>
    </html>
